...
dir = os.path.join(FILE_ROOT_DIRECTORY, 'src/resource/LookalikeOrigin')  # 原始数据的路径
...
dataDevPD.to_csv(os.path.join(FILE_ROOT_DIRECTORY, 'src/resource/DataCleaning/Dev.csv'), encoding='utf-8_sig')
dataAoiPD.to_csv(os.path.join(FILE_ROOT_DIRECTORY, 'src/resource/DataCleaning/Aoi.csv'), encoding='utf-8_sig')
dataAppPD.to_csv(os.path.join(FILE_ROOT_DIRECTORY, 'src/resource/DataCleaning/App.csv'), encoding='utf-8_sig')
